      ...
      <div className="container mx-auto flex lg:flex-row flex-col justify-between gap-5 p-5 ">
        <div className="mt-20">
          <div className="bg-white rounded-lg shadow-lg ">
            <h1 className="text-3xl font-medium  py-[50px] text-center">
              Request For Proposal
            </h1>
          </div>
          <h1 className="text-xl font-medium  py-4 text-center border-b-2 border-black mb-5">
            PROJECT INFO
          </h1>
          ...
          <div>
            <form action="">
              ...
              <div className="mb-6  space-y-5">
                ...
                <textarea
                  type="text"
                  className="form-control block w-full px-4 py-2 text-sm border border-blue-900 text-gray-700 bg-white bg-clip-padding shadow-lg  rounded-lg focus:outline-none"
                  id="exampleFormControlInput2"
                  rows="2"
                  placeholder="Example: Rexoit is one of the leading software companies in Bangladesh."
                />
                  ...
                  <div className="flex items-center gap-2 ">
                    <div>
                      <div class="form-check">
                        ...
                        />
                        <label
                          class="form-check-label inline-block text-gray-800 text-lg"
              ...
              <h1 className="text-xl font-medium  py-10 text-center ">
                GENERAL FEATURES
              </h1>
              ...
              <div className="mb-6">
                ...
                >
                  {" "}
                  Upload Document (pdf, docx, png, jpeg) :{" "}
                </label>
                <input
                  class="form-control
    block
    ...
    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
        ...
        <div className="mt-20">
          <div className="bg-white rounded-lg shadow-lg p-5">
            ...
            <div className="h-[150px] w-[150px] mx-auto mb-10 shadow-slate-400 shadow-xl bg-slate-600 rounded-full "></div>

            <h1 className="text-lg font-medium mb-2  text-center text-gray-500">
              Your Completion Percentage
            </h1>
            <p className="max-w-xl text-gray-400">
              A request for proposal (RFP) is an open request for bids to
              complete a new project proposed by the company that issues it. An
              RFP must describe and define the project/software in enough detail
              to attract viable responses. The prospective company should be
              able to understand the nature of the business, the requirements of
              the software, and the goals it wishes to achieve with the project.
              The project must be defined in enough detail for the software
              development company to clearly understand its scopes like
              Technical requirements, project timeframe, budget, and all of the
              products and services that must be provided to carry it out. A
              well-written RFP conveys the intention behind the proposal and
              ensures that the result will meet expectations. It also ensures an
              open process.
            </p>
          </div>
        </div>
